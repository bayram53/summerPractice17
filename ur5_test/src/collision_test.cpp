...
int main(int argc, char **argv){
    ...
    primitive_3.dimensions[0] = 0.2;
    primitive_3.dimensions[1] = 0.2;
    primitive_3.dimensions[2] = 0.2;
    ...
    primitive_4.dimensions[0] = 0.2;
    primitive_4.dimensions[1] = 0.2;
    primitive_4.dimensions[2] = 0.2;
...
*/
	...
	*/
    ...
    target_pose1.orientation.x = 0.250755;
    target_pose1.orientation.y = -0.661159;
    target_pose1.orientation.z = 0.250746;
    target_pose1.orientation.w = 0.661148;

    // we set positions for our pose
    target_pose1.position.x = 0.755084;
    target_pose1.position.y = 0.242831;
    target_pose1.position.z = 0.163861;
